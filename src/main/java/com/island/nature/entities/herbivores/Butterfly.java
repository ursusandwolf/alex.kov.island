...
public class Butterfly extends SwarmOrganism {
    public Butterfly(Configuration config, long initialBiomass, int speed) {
        super(config, "Butterfly", SpeciesKey.BUTTERFLY, 1000L * config.getScale1M(), speed, 30, 
