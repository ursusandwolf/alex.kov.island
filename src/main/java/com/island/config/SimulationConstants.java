...
public final class SimulationConstants {
    ...
    // Plants logic (Aggressive growth to support dense population)
    public static double PLANT_INITIAL_BIOMASS_FACTOR = 0.5; 
    public static double PLANT_GROWTH_RATE_MIN = 0.50; // 50% min
    public static double PLANT_GROWTH_RATE_MAX = 1.00; // 100% max (full recovery)

    public static final double GRASS_WEIGHT = 1.0;
    public static final int GRASS_MAX_COUNT = 1000; // Increased to 1000
    public static final double CABBAGE_WEIGHT = 2.0;
    public static final int CABBAGE_MAX_COUNT = 500; // Increased to 500
