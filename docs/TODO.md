...
- [ ] Добавить Javadoc к `EventBus.subscribe()` с описанием type hierarchy
- [ ] Добавить тест `EventBusTest.subscribingToObjectClassReceivesAllEvents()`
- [ ] Рассмотреть добавление `publishAsync()` для неблокирующей публикации
